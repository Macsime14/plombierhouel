...
export const qualifications = {
  title: "Des qualifications qui comptent.",
  items: ["CAP Installateur sanitaire", "Attestation fluides frigorigènes", "RGE", "Assurance décennale"],
  note: "Concrètement : un travail conforme aux normes, et des travaux de chauffage éligibles aux aides de l'État.",
};
